...
local Config = {
    ...
    Secret          = "2390", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/MBHubRoblox/bng/refs/heads/main/README.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "yamemehub", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "newyamemehub", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "Yameme Hub", -- The main title shown at the top of the GUI
    HubDescription  = "yan xiaomei" -- The text shown below the title
}
